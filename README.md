...
```mermaid
flowchart TD
    A([01. Tarih Öncesi Sistemler]) -->|Tarım Devrimi| B([02. Antik Çağ İmparatorlukları])
    B -->|Batı Roma'nın Çöküşü| C([03. Orta Çağ, Din ve Feodalite])
    C -->|Coğrafi Keşifler & Barut| D([04. Küresel Kesişimler ve Aydınlanma])
    D -->|Buhar Gücü & Fransız İhtilali| E([05. Sanayi Devrimi ve Ulus Devletler])
    E -->|Büyük Buhran & Dünya Savaşları| F([06. Küresel Savaşlar ve İdeolojiler])
    F -->|Mikroçip & İnternet Devrimi| G([07. Bilgi Çağı ve Teknolojik Evrim])
```
